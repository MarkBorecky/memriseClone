...
import com.grupa3.memriseclone.repository.TagRepository;
...
public class TagResourceIT {
    ...
    public void createTag() throws Exception {
        ...
        assertThat(testTag.getLang()).isEqualTo(DEFAULT_LANG);
    }
    ...
    public void updateTag() throws Exception {
        ...
        Tag testTag = tagList.get(tagList.size() - 1);
        assertThat(testTag.getLang()).isEqualTo(UPDATED_LANG);
    }
